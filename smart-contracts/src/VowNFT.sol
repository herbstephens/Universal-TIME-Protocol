...
contract VowNFT is ERC721, Ownable {
    ...
    /// @notice Return metadata as base64 JSON. marriageDate is UNIX timestamp (number).
    function tokenURI(uint256 id) public view override returns (string memory) {
        _requireOwned(id); // revert if token not minted
    ...
    /*                             SOULBOUND OVERRIDES                            */
    /* -------------------------------------------------------------------------- */
    /// @dev Override to disable transfers
