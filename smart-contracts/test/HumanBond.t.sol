...
contract AutomationFlowTest is Test {
    ...
    function test_accept_getMarriageId_recordsMarriageIdSymmetryAndPushToArray() public marriedCouple {
        bytes32 id1 = humanBond.getMarriageId(leticia, bob);
        bytes32 id2 = humanBond.getMarriageId(bob, leticia);
    ...
    function test_checkAndMintMilestone_mintsMultipleYears() public marriedCouple {
    ...
    function test_checkAndMintMilestone_capsToLatestYear() public marriedCouple {
    ...
    function test_checkAndMintMilestone_updatesStateCorrectly() public marriedCouple {
        // warp 2 years
        skip(2 * 3 minutes + 1);
    ...
    function test_checkAndMintMilestone_partialYears() public marriedCouple {
    ...
    function test_checkAndMintMilestone_emitsEventsForAllYears() public marriedCouple {
        skip(2 * 3 minutes + 1);
