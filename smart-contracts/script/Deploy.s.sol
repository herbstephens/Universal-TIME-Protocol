...
contract DeployScript is Script {
    ...
    function run() external {
        ...
        uint256 externalNullifierPropose = abi.encodePacked(abi.encodePacked(appId).hashToField(), "propose-bond").hashToField();
        uint256 externalNullifierAccept = abi.encodePacked(abi.encodePacked(appId).hashToField(), "accept-bond").hashToField();
